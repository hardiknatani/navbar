...
class LithologyScreen extends StatefulWidget {
  const LithologyScreen({super.key});
  static const routeName = '/lithology';

  @override
  State<LithologyScreen> createState() => _LithologyScreenState();
}

class _LithologyScreenState extends State<LithologyScreen> {
  @override
